...
ssh panagopkonst@memos1.troias.offices.aueb.gr "cd ../../; ls -l /taq93-23/taq${year}taq$y*/cq_*" | awk '{print $9, $5}' | awk -F/ '{print $4, $5}' | sed 's/.gz//' | sed 's/.bz2//' > memo_size
ssh wrds ls -l /wrdslin/taq.$year/taq*d/sasdata/cq* |awk '{print $9,$5}' |awk -F/ '{print $6, $7}' |sed 's/.gz//'| sed 's/.bz2//' >wrds_size
